...
var TaskForm = /** @class */ (function (_super) {
    ...
    TaskForm.prototype.render = function () {
        return (react_1.default.createElement("form", { onSubmit: this.addTask },
            react_1.default.createElement("input", { type: "text", onChange: this.titleChanged, value: this.state.title }),
